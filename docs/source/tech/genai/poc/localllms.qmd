...
-   There are other Options available
    ...
    -   Commercially Usable
    -   Self-Hosted
    -   Deployable on On Commodity Hardware (for prototyping & evaluation)
...
-   We fine-tune and create new custom models just like docker images
...
-   from Nomic AI
-   Provides an echo system from training of an LLM to framework to interact
...
-   **Cons**
    ...
    -   On our own for Deployment & Scalability in all aspects

------------------------------------------------------------------------

### Typical Environment used for Evaluation
...
|                  | \- Cant just trust LLM to modify the original code.                                                                                    |
...
-   Though Function calling supported in Llama model, its not as powerful as OpenAI and others
...
-   Debugging with LangSmith is not easy at beginning
...
-   If want more adventurous life, sure LangChain NodeJS framework is a best friend
